...
var JavaScriptHighlightRules = function(options) {
    var keywordMapper = this.createKeywordMapper({
        ...
        "keyword":
            "const|yield|async|await|import|get|set|" +
    ...
    this.$rules = {
        "no_regex" : [
            ...
            DocCommentHighlightRules.getStartRule("doc-start"),
            {
                ...
                token : [
                    "entity.name.function", "text", "keyword.operator", "text", "await", "text", "storage.type",
                    "text", "paren.lparen"
                ],
                regex : "(" + identifierRe +")(\\s*)(=)(\\s*)(await)(\\s+)(function)(\\s*)(\\()",
                next: "function_arguments"
            }, {
                token : [
                    "storage.type", "punctuation.operator", "entity.name.function", "text",
                ...
                token : [
                    "async", "text", "storage.type", "text", "entity.name.function", "text", "paren.lparen"
                ],
                regex : "(async)(\\s+)(function)(\\s+)(" + identifierRe + ")(\\s*)(\\()",
                next: "function_arguments"
            }, {
                token : [
